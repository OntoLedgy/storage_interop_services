...
func parseFlags(xsdFileName, targetCodeFileName, targetLanguage string) *Config {
	iPtr := flag.String("i", xsdFileName, "Input file path or directory for the XML schema definition")
	oPtr := flag.String("o", targetCodeFileName, "Output file path or directory for the generated code")
	pkgPtr := flag.String("p", "", "Specify the package name")
	langPtr := flag.String("l", targetLanguage, "Specify the language of generated code")
...
func ConvertXSDtoCode(xsdFileName, targetCodeFileName, targetLanguage string) {
	...
	cfg := parseFlags(xsdFileName, targetCodeFileName, targetLanguage)
